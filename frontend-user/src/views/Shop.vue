          ...
          <div class="product-body">
            ...
            <div class="foot">
              ...
              <div class="actions">
                ...
                <el-button :type="isFavorite(item.id) ? 'danger' : 'info'" size="small" text @click="onToggleFavorite(item)">
...
import { addToCart, addToFavorite, removeFromFavorite } from '../api/cart'
